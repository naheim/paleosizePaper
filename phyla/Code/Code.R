#Graph 1: Diversification 5 panel

time.plot.mult(ncol = 3, nrow = 2,time.height=0.8,top.mar=1.5, cex.lab = 1.2, cex.axis = 1.25)

plot(timescale$age_mid,divRate$Arthropoda,type="l",col='#ee92ed',xlim=c(541,0), ylim=c(0,1), xlab="", ylab= " Diversification Rate (%)",main="Arthropoda", xaxt = "n", lwd = 3)
abline(v=443.8, lty = 5) #Ordivician
abline(v=358.9, lty = 5) #Devonian
abline(v=252.17, lty = 5) #Permian
abline(v=201.3, lty = 5) #Triassic
abline(v=66, lty = 5) #Cretaceous
plot(timescale$age_mid,divRate$Brachiopoda,type="l",col='#ff5640',xlim=c(541,0), ylim=c(0,1), xlab="", ylab= "Diversification Rate (%)", main ="Brachiopoda", xaxt = "n",lwd = 3)
...
plot(timescale$age_mid,divRate$Chordata,type="l",col='#ffd900',xlim=c(541,0), ylim=c(0,1), xlab="", ylab= "Diversification Rate (%)",main="Chordata", xaxt = "n",lwd = 3)
abline(v=443.8, lty = 5, col = "azure4") #Ordivician
abline(v=358.9, lty = 5, col = "azure4") #Devonian
abline(v=252.17, lty = 5, col = "azure4") #Permian
abline(v=201.3, lty = 5, col = "azure4") #Triassic
abline(v=66, lty = 5, col = "azure4") #Cretaceous
plot(timescale$age_mid,divRate$Echinodermata,type="l",col='#00ffd7',xlim=c(541,0), ylim=c(0,1), xlab="", ylab= "Diversification Rate(%)", main = "Echinodermata", xaxt = "n",lwd = 3)
abline(v=443.8, lty = 5, col = "azure4") #Ordivician
abline(v=358.9, lty = 5, col = "azure4") #Devonian
abline(v=252.17, lty = 5, col = "azure4") #Permian
abline(v=201.3, lty = 5, col = "azure4") #Triassic
abline(v=66, lty = 5, col = "azure4") #Cretaceous
plot(timescale$age_mid,divRate$Mollusca,type="l",col='#0000ff',xlim=c(541,0), ylim=c(0,1), xlab="", ylab= "Diversification Rate(%)",main= "Mollusca", xaxt = "n", lwd = 3)
abline(v=443.8, lty = 5, col = "azure4") #Ordivician
abline(v=358.9, lty = 5, col = "azure4") #Devonian
abline(v=252.17, lty = 5, col = "azure4") #Permian
abline(v=201.3, lty = 5, col = "azure4") #Triassic
...
plot(1:10, type="n", xlim=c(541,0), ylim=c(0,0.125), xlab="", ylab= "Diversification Rate", main = "General Trend", xaxt = "n")
abline(v=443.8, lty = 5, col = "azure4") #Ordivician
abline(v=358.9, lty = 5, col = "azure4") #Devonian
abline(v=252.17, lty = 5, col = "azure4") #Permian
abline(v=201.3, lty = 5, col = "azure4") #Triassic
...
time.plot(c(0,1), "Proportion of Phylum (# of Taxa)", cex.lab = 1.2, mar = c(4.5,4.5,4.5,4.5)+0.1, mgp=c(3, 0.75, 0), cex.axis = 1.25, width = 9)
...
#Graph 5: Mean Size w/Confidence Interval
time.plot.mult(nrow=2, ncol = 3,time.height=0.8,top.mar=1.5,cex.lab = 1.2, cex.axis = 1.25)

plot(timescale$age_mid,meanSize$Arthropoda,type="l",col='#ee92ed',xlim=c(541,0), ylim=c(0,9), xlab="", ylab= "Biovolume (log10mm3) ", xaxt = "n", main = "Arthropoda"  )
...
abline(v=201.3, lty = 5, col = "azure4") #Triassic
abline(v=66,lty = 5, col = "azure4") #Cretaceous
plot(timescale$age_mid,meanSize$Brachiopoda,type="l",col='#ff5640',xlim=c(541,0), ylim=c(0,9), xlab="", ylab= "Biovolume (log10mm3)", xaxt = "n", main="Brachiopoda")
...
abline(v=201.3, lty = 5, col = "azure4") #Triassic
abline(v=66,lty = 5, col = "azure4") #Cretaceous
plot(timescale$age_mid,meanSize$Chordata,type="l",col='#ffd900',xlim=c(541,0), ylim=c(0,9), xlab="", ylab= "Biovolume (log10mm3)", xaxt = "n", main = "Chordata")
...
abline(v=201.3, lty = 5, col = "azure4") #Triassic
abline(v=66,lty = 5, col = "azure4") #Cretaceous
plot(timescale$age_mid,meanSize$Echinodermata,type="l",col='#00ffd7',xlim=c(541,0), ylim=c(0,9), xlab="", ylab= "Biovolume (log10mm3)", xaxt = "n", main = "Echinodermata")
library(paleoTS)
n.bins <- nrow(timescale)
my.mean <- vector(mode="numeric", length=n.bins) 
my.var <- vector(mode="numeric", length=n.bins)
...
plot(timescale$age_mid,meanSize$Mollusca,type="l",col='#0000ff',xlim=c(541,0), ylim=c(0,9), xlab="", ylab= "Biovolume (log10mm3)",xaxt = "n", main = "Mollusca")
...
plot(1:10, type="n", xlim=c(541,0), ylim=c(-2,12), xlab="", ylab= "Biovolume (log10mm3)",main = "Full Size Range", xaxt = "n" )
SizeData$color <- NA
