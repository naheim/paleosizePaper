...
plot(1:10,1:10, type="n", xlim=c(541,-5), ylim=range(my.tiering), pch=21, xlab="Geologic Time (Ma)", ylab="Amount of Gentra", main="The Change in the Amount of Gentra Categorized by Tiering Level Over Million-Years")
